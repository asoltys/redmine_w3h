...
The plugin can be downloaded to https://github.com/asoltys/redmine_w3h
...
If you need help, you can contact the maintainer, Adam Soltys, at adam.soltys@pwgsc-tpsgc.gc.ca 
